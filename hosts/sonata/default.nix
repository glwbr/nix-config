  ...
  aria = {
    core.users = {
      ...
      users.${username} = {
        ...
        sshKeys = [ "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIOw9mnJmXKHKGvkdlSHJ7dFP2XhlKvQbKogHxwBXFg9o" ];
        extraOptions.packages = with pkgs; [ kitty firefox spotify telegram-desktop (discord.override { withVencord = true; }) ];
      };
    };
